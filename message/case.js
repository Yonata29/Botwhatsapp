...
var Ownerin ="6287778405247@s.whatsapp.net"
...
title: `Adelin Botz V.2`,
body:`SOURCE CODE`,
previewType:"PHOTO",
thumbnail: fs.readFileSync('./stik/reply.jpg'),
sourceUrl:`https://reii-store.my.id/`
}
}
...
previewType:"PHOTO", 
thumbnail: fs.readFileSync('./stik/reply.jpg'),
sourceUrl:`https://chat.whatsapp.com/KVXYuYy9KvN8VKyDrhhPcc`
...
thumbnail: fs.readFileSync('./stik/reply.jpg'),
sourceUrl:`https://chat.whatsapp.com/KVXYuYy9KvN8VKyDrhhPcc`
}}, image: fs.readFileSync('./stik/thumb.jpeg'), caption: anu}, { quoted: m })
}
break    
...
case 'shop':{
	let teks = `
Hai Kak👋 ${m.pushName}𝐁𝐞𝐫𝐢𝐤𝐮𝐭 𝐀𝐝𝐚𝐥𝐚𝐡 𝐌𝐞𝐧𝐮 𝐀𝐃𝐄𝐋𝐈𝐍 𝐒𝐓𝐎𝐑𝐄 
...
𝐀𝐝𝐚 𝐲𝐚𝐧𝐠 𝐛𝐢𝐬𝐚 𝐤𝐚𝐦𝐢 𝐛𝐚𝐧𝐭𝐮?
  Panel Hosting Bot By YogzzDevX_
⎇ PAKET G1
...
Group YogzzDevX:
https://chat.whatsapp.com/L9iLy6q6cOAGaCg0leCMOs
...
let repli = `Total pengguna bot Adelin sekarang adalah ${Object.keys(db.data.users).length} Orang`
//let repli2 = `${block == undefined ? '*0* Diblokir' : '*' + block.length + '* Diblokir'}`
let repli3 = `*BOT DEVELOPER BY Reii code*`
