...
return result
  ...
  pack: "Adelin", // The pack name
  author: "Sad", // The author name
...
return await conn.sendMessage(jid, { [`${pase}`]: data, mimetype: mime, ...options }, { quoted })
  ...
  */
  ...
  +"item2.EMAIL;type=INTERNET:Adelinbot@gmail.com\n"
  +"item2.X-ABLabel:Email\nitem3.URL:https://instagram.com/not_rei1\n"
  +"item3.X-ABLabel:Instagram\n"
  +"item4.ADR:;;Karawang,Indonesia;;;;\n"
...
sourceUrl:`https://tiktok.com/@danukiding`
}}, contacts: {
displayName: (contacts.length > 1 ? `2013 kontak` : contacts[0].displayName) || null,
contacts,
}
